...
describe('<SearchField />', () => {
    it('renders a parent div with 2 children (<i> & <input>)', () => {
        ...
        const searchQuery = wrapper.find('div.vdp-search-field');
        expect(searchQuery.exists()).toBe(true);
        expect(searchQuery.find('i.vdp-search-field__icon-search').exists()).toBe(true);
        expect(searchQuery.find('input.vdp-search-field__input').exists()).toBe(true);
    });
    ...
    it('renders a parent div with 3 children (two <i> & one <input>)', () => {
        ...
        expect(searchQuery.find('i.vdp-search-field__icon-search').exists()).toBe(true);
        expect(searchQuery.find('input.vdp-search-field__input').exists()).toBe(true);
        expect(searchQuery.find('i.vdp-search-field__icon-close').exists()).toBe(true);
    });
    ...
    it('renders an <input> element with the appropriate props)', () => {
        ...
        const searchQuery = wrapper.find('input.vdp-search-field__input');
        expect(searchQuery.exists()).toBe(true);
